...
- (Live-action "woman at a table" version — see the videos README; needs HeyGen sign-in)

## 📄 Files buyers download — `marketing/delivery-pdfs/`
Attach these to the Etsy listing as the digital files (Etsy allows 5):
- `1-Welcome-Start-Here.pdf` — **add your app link first** (see below)
- `2-Companion-Binder-15-Pages.pdf` — the printable binder
...
2. Put that link in `1-Welcome-Start-Here.pdf` (I'll do it — just send me the link)
3. Optional Canva editable bundle → `docs/printable-companion-guide.md`
